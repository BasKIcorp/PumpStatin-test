...
/** Вертикальный плакат в левой колонке воронки (советский стиль, «Слава КПСС») */
export const FUNNEL_SIDEBAR_WORDMARK_DEFAULT = staticUrl("/selection-assets/slava-kpss-poster.svg");
