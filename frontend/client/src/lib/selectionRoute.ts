...
export const HYDROMODULE_CARD_FORM_FIELD: Record<HydromoduleLineId, string> = {
  ...
  "bps-c-huynya": "hm_card_bps_c_huynya",
};
...
/** Серии на промежуточном экране воронки «Гидромодули» */
export const HYDROMODULE_SERIES_ORDER: HydromoduleLineId[] = [
  "bps-c-pro",
  "bps-c-lite",
  "bps-c-e",
  "bps-c-mini",
