  ...
  return (
    <div className="flex h-full min-h-[calc(100vh-8rem)] gap-4">
      <aside className="w-48 shrink-0">
        ...
        <TabNav tabs={STUDIO_TABS} activeTab={activeTab} onSelect={onTabChange} />
      </aside>

      <div
        className={`min-w-0 flex-1 overflow-hidden rounded-lg border border-neutral-200 bg-white ${
          flush ? "p-0" : "p-4"
        }`}
      >
        {children}
